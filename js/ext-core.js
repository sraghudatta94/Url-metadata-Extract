...
(function() {
    ...
    Ext.apply(Ext, {
        ...
        urlEncode: function(H, G) {
            ...
            Ext.iterate(H, function(e, I) {
                ...
                Ext.each(E
                    ? e
                    : I, function(J) {
                    D.push("&", F(e), "=", (!Ext.isEmpty(J) && (J != e || !E))
                        ? (Ext.isDate(J)
                            ? Ext.encode(J).replace(/"/g, "")
                            : F(J))
                        : "")
                })
            });
                ...
                return function(D) {
                    if (D && D.tagName != "BODY") {
                        (Ext.enableNestedListenerRemoval)
                            ? Ext.EventManager.purgeElement(D, true)
        ...
        isEmpty: function(D, e) {
            return D === null || D === undefined || ((Ext.isArray(D) && !D.length)) || (!e
                ? D === ""
                : false)
        },
        isArray: function(e) {
...
(function() {
    ...
    function c(d) {
        ...
        Ext.lib.Dom = {
            ...
            getDocumentHeight: function() {
                return g(!e
                    ? h.body.scrollHeight
                    : h.documentElement.scrollHeight, this.getViewportHeight())
            },
            getDocumentWidth: function() {
                return g(!e
                    ? h.body.scrollWidth
                    : h.documentElement.scrollWidth, this.getViewportWidth())
            },
    ...
    Ext.lib.Event = function() {
        ...
        var z = {
            ...
            getRelatedTarget: function(I) {
                I = I.browserEvent || I;
                return this.resolveTextNode(I.relatedTarget || (I.type == G
                    ? I.toElement
                    : I.type == A
                        ? I.fromElement
                        : null))
    ...
    Ext.lib.Ajax = function() {
        ...
        var l = {
            ...
            serializeForm: function(s) {
                var t = s.elements || (document.forms[s] || Ext.getDom(s)).elements,
                    z = false,
                    ...
                    if (!B.disabled && r) {
                        if (/select-(one|multiple)/i.test(x)) {
                            Ext.each(B.options, function(C) {
                                if (C.selected) {
                                    v += String.format("{0}={1}&", y(r), y((C.hasAttribute
                                        ? C.hasAttribute("value")
                                        : C.getAttribute("value") !== null)
                                        ? C.value
                                        : C.text))
                                }
                            })
    ...
    (function() {
        var h = Ext.lib,
            j = /width|height|opacity|padding/i,
            g = /^((width|height)|(top|left))$/,
            d = /width|height|top$|bottom$|left$|right$/i,
            i = /\d+(em|%|en|ex|pt|in|cm|mm|pc)$/i,
            k = function(l) {
        ...
        h.AnimBase.prototype = {
            ...
            getAttr: function(l) {
                ...
                return (!!(m[2]) || (n.getStyle("position") == "absolute" && !!(m[3])))
                    ? n.dom["offset" + m[0].charAt(0).toUpperCase() + m[0].substr(1)]
                    : 0
            },
        ...
        (function() {
            ...
            var o = h.Motion.superclass,
                n = h.Motion.prototype,
                m = /^points$/i;
            Ext.apply(h.Motion.prototype, {
                ...
                doMethod: function(p, s, q) {
                    var r = this;
                    return m.test(p)
                        ? h.Bezier.getPosition(r.runAttrs[p], r.method(r.curFrame, 0, 100, r.totalFrames) / 100)
                        : o.doMethod.call(r, p, s, q)
                },
                setRunAttr: function(w) {
                    if (m.test(w)) {
                        var y = this,
                            r = this.el,
                            B = this.attributes.points,
                            u = B.control || [],
                            z = B.from,
                            A = B.to,
                            x = B.by,
    ...
    (function() {
        ...
        Ext.apply(g.Easing, {
            ...
            elasticBoth: function(m, k, r, q, l, o) {
                ...
                return m < 1
                    ? -0.5 * (l * h(2, 10 * (m -= 1)) * e((m * q - n) * (2 * j) / o)) + k
                    : l * h(2, -10 * (m -= 1)) * e((m * q - n) * (2 * j) / o) * 0.5 + r + k
            },
            ...
            backBoth: function(l, k, o, n, m) {
                m = m || 1.70158;
                return ((l /= n / 2) < 1)
                    ? o / 2 * (l * l * (((m *= (1.525)) + 1) * l - m)) + k
                    : o / 2 * ((l -= 2) * l * (((m *= (1.525)) + 1) * l + m) + 2) + k
            },
            ...
            bounceBoth: function(l, k, n, m) {
                return (l < m / 2)
                    ? g.Easing.bounceIn(l * 2, 0, n, m) * 0.5 + k
                    : g.Easing.bounceOut(l * 2 - m, 0, n, m) * 0.5 + n * 0.5 + k
            }
        })
    })();
    (function() {
    ...
    p = {
        ...
        insertHtml: function(y, t, z) {
            ...
            if (t.insertAdjacentHTML) {
                ...
                B = "setStart" + (/end/i.test(y)
                    ? "After"
                    : "Before");
                if (x[y]) {
                    A[B](t);
                    C = A.createContextualFragment(z);
                    t.parentNode.insertBefore(C, y == c
                        ? t
                        : t.nextSibling);
                    return t[(y == c
                            ? "previous"
...
Ext.Template.prototype = {
    ...
    applyTemplate: function(a) {
        ...
        return b.compiled
            ? b.compiled(a)
            : b.html.replace(b.re, function(c, d) {
    ...
    return {
        ...
        is: function(el, ss) {
            ...
            var isArray = Ext.isArray(el),
                result = Ext.DomQuery.filter(isArray
                    ? el
                    : [el], ss);
            return isArray
...
(function() {
    var a = function() {
        ...
        if (Ext.isSafari) {
            b.push("ext-safari " + (Ext.isSafari2
                ? "ext-safari2"
                : (Ext.isSafari3
                    ? "ext-safari3"
                    : "ext-safari4")))
...
Ext.EventObject = function() {
    ...
    Ext.EventObjectImpl.prototype = {
        ...
        getTarget: function(e, g, d) {
            return e
                ? Ext.fly(this.target).findParent(e, g, d)
                : (d
                    ? Ext.get(this.target)
                    : this.target)
        },
...
(function() {
    ...
    h.prototype = {
        ...
        contains: function(o) {
            return !o
                ? false
                : Ext.lib.Dom.isAncestor(this.dom, o.dom
                    ? o.dom
                    : o)
        },
    ...
    return {
        ...
        createChild: function(e, d, g) {
            ...
            return d
                ...
                : b[!this.dom.firstChild
                        ? "overwrite"
                        : "append"](this.dom, e, g !== true)
        },
        wrap: function(d, e) {
    ...
    return {
        ...
        addClass: function(H) {
            ...
            for (G = 0, E = H.length; G < E; G++) {
                F = H[G];
                if (F) {
                    I.dom.className += (!I.hasClass(F) && F
                        ? " " + F
                        : "")
                }
            }
        ...
        radioClass: function(H) {
            var I = this.dom.parentNode.childNodes,
                F;
            H = Ext.isArray(H)
                ? H
                : [H];
        ...
        getStyle: function() {
            return s && s.getComputedStyle
                ...
                : function(I) {
                    ...
                    I = v(I);
                    return G.style[I] || ((F = G.currentStyle)
                        ? F[I]
                        : null)
                }
        }(),
        getColor: function(E, F, J) {
            var H = this.getStyle(E),
                G = Ext.isDefined(J)
                    ? J
                    : "#",
                I;
            ...
            if (!E || !I.anim) {
                if (Ext.isIE) {
                    var H = F < 1
                            ? "alpha(opacity=" + F * 100 + ")"
                            : "",
                        J = G.filter.replace(C, "").replace(l, "");
                    G.zoom = 1;
                    G.filter = J + (J.length > 0
                        ? " "
                        : "") + H
                } else {
                    G.opacity = F
        ...
        getHeight: function(G) {
            var F = this,
                I = F.dom,
                H = Ext.isIE && F.isStyle("display", "none"),
                E = r.max(I.offsetHeight, H
                    ? 0
                    : I.clientHeight) || 0;
            E = !G
                ? E
        ...
        getWidth: function(F) {
            var G = this,
                I = G.dom,
                H = Ext.isIE && G.isStyle("display", "none"),
                E = r.max(I.offsetWidth, H
                    ? 0
                    : I.clientWidth) || 0;
            E = !F
                ? E
                : E - G.getBorderWidth("lr") - G.getPadding("lr");
            return E < 0
                ? 0
                : E
        },
        ...
        setHeight: function(E, F) {
            ...
            E = G.adjustHeight(E);
            !F || !G.anim
                ? G.dom.style.height = G.addUnits(E)
                : G.anim({
                    height: {
                        to: E
                    }
...
(function() {
    ...
    Ext.Element.addMethods({
        ...
        setX: function(l, m) {
            return this.setXY([
                l, this.getY()
            ], this.animTest(arguments, m, 1))
        },
        setY: function(m, l) {
            return this.setXY([
                this.getX(), m
            ], this.animTest(arguments, l, 1))
        },
        setLeft: function(l) {
        ...
        getLeft: function(l) {
            return !l
                ? this.getX()
                : parseInt(this.getStyle(b), 10) || 0
        },
        getRight: function(l) {
            var m = this;
            return !l
                ? m.getX() + m.getWidth()
                : (m.getLeft(true) + m.getWidth()) || 0
        },
        getTop: function(l) {
            return !l
                ? this.getY()
                : parseInt(this.getStyle(d), 10) || 0
        },
        getBottom: function(l) {
            var m = this;
            return !l
                ? m.getY() + m.getHeight()
                : (m.getTop(true) + m.getHeight()) || 0
        },
    ...
    Ext.Fx = {
        ...
        fadeOut: function(E) {
            ...
            C.queueFx(E, function() {
                arguments.callee.anim = p(D).fxanim({
                    ...
                    if (F == 0) {
                        Ext.Element.data(D, "visibilityMode") == Ext.Element.DISPLAY || E.useDisplay
                            ? B.display = "none"
                            : B.visibility = w;
                        p(D).clearOpacity()
                    }
        ...
        shift: function(D) {
            ...
            this.queueFx(D, function() {
                ...
                B.width
                    ? B.width.to = p(C).adjustWidth(D.width)
                    : B;
                B.height
                    ? B.height.to = p(C).adjustWidth(D.height)
                    : B;
                if (B.x || B.y || B.xy) {
                    B.points = B.xy || {
                        to: [
            ...
            if (s.fireEvent(b, s, n)) {
                if (n.el) {
                    ...
                    n.success = (Ext.isFunction(n.success)
                        ? n.success
                        : function() {}).createInterceptor(function(o) {
                ...
                l = Ext.urlEncode(s.extraParams, Ext.isObject(l)
                    ? Ext.urlEncode(l)
                    : l);
                if (Ext.isFunction(k)) {
                ...
                j = n.method || s.method || ((l || n.xmlData || n.jsonData)
                    ? i
                    : a);
                ...
                return n.callback
                    ? n.callback.apply(n.scope, [n, h, h])
                    : null
            }
        },
        isLoading: function(j) {
            return j
                ? Ext.lib.Ajax.isCallInProgress(j)
                : !!this.transId
        },
        abort: function(j) {
            if (j || this.isLoading()) {
